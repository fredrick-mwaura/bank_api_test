...
router.get("/transaction/:id", ValidationMiddleware.validateObjectId("id"), transactionController.getTransaction)
...
// Deposit operations
router.post("/deposit", rateLimiters.transaction, ValidationMiddleware.validateDeposit(), transactionController.deposit)
...
router.get("/scheduled", ValidationMiddleware.validatePagination(), transactionController.getScheduledTransactions)

router.post("/schedule", ValidationMiddleware.validateScheduledTransaction(), transactionController.scheduleTransaction)
...
router.get("/disputes", ValidationMiddleware.validatePagination(), transactionController.getDisputes)
